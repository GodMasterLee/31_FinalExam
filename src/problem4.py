...
def main():
    ...
    print(Pig_A.get_weight())
    Pig_B.eat(500)
    print(Pig_B.get_weight())
    Pig_B.eat_for_a_year()
    print(Pig_B.get_weight())
    print(Pig_A.heavier_pig(Pig_C).get_weight())
    print(Pig_A.new_pig(Pig_C).get_weight())
...
class Pig(object):
    ...
    def new_pig(self, other_pig):
        ...
        """
        # Done: Implement and test this method.
        return Pig(self.heavier_pig(other_pig).get_weight() + other_pig.get_weight())
